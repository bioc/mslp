...
`scr_slp` and `cons_slp` are used for these two steps, respectively. By default, test on Cohen's kappa coefficient is used to access the consistency.
...
k_res <- cons_slp(scr_res, tumour_slp = merged_res, method = "Kappa_test")

...
Here we load toy datasets. `mslp` uses `Future` as the paraellel backend, and it is recommend to paraellel th compuation for `corr_slp`, `comp_slp`, `cons_slp` and `est_im`.
